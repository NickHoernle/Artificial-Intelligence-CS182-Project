...
best_centroid, best_cost, k_points, k_initial = local_beam_search(10, intersection_graph, connection_dict, get_road_cost, euclidean_heuristic, starting_points=starting_points)
